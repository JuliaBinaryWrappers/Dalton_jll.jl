# `Dalton_jll.jl` (v2020.1.0+0)

[![deps](https://juliahub.com/docs/Dalton_jll/deps.svg)](https://juliahub.com/ui/Packages/Dalton_jll/4wmHn?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/7de222052ab5b82f42cfa2cb5903bec50231b878/D/Dalton/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `Dalton_jll.jl` have been built from these sources:

* git repository: https://gitlab.com/dalton/dalton/ (revision: `9d7c5e435b75a9695d5ac8714121d12e6486149f`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/7de222052ab5b82f42cfa2cb5903bec50231b878/D/Dalton/bundled)

## Platforms

`Dalton_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `Dalton_jll.jl`:
...
* `ExecutableProduct`: `dalton`
* `ExecutableProduct`: `dalton_x`
